...
def validation_split(direct_name, N_test=5000):
    ...
    # The training set is divided proportionally between the training set and the test set, and then expanded separately. Next, pick 500 of the test set to validate.
    data_train = []
