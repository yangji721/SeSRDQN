...
class ActDNN(object):
    ...
    def _build_network(self):
        ...
        self.q = self.q - self.input_state * 1000 # use 1000 to lower the influence of the state
        self.q = tf.nn.softmax(self.q, axis=1) # -1, n_s
        self.q = tf.multiply(self.q, tf.ones_like(self.input_state) - self.input_state) # filter out the state 
